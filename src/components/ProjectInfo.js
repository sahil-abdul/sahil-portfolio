  ...
  const Todo = {
    ...
    content: "A simple and efficient task management app built with React and Redux Toolkit. It allows users to add, delete, Designed for a smooth user experience with a clean UI and optimized state management using Redux Toolkit’s powerful features.",
